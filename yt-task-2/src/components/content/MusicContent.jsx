...
// Context banaya jisme music ka data store hoga
const MusicContext = createContext();

// Songs ki list (hardcoded data)
const songs = [
    {
        id: 1,
        title: "Keep You Away",
    ...
    },
    {
        ...
        title: "Riha",
        artist: "Annu jann",
        url: "/song/Riha song.wav",
        duration: "4:53",
    },
];

// Provider component jo app ko data dega
export const MusicProvider = ({ children }) => {
    // State variables banaye
    ...
    // LocalStorage se playlists load karna
    useEffect(() => {
    ...
    // Playlists ko localStorage mein save karna
    useEffect(() => {
    ...
    // Time format karna (seconds → minutes:seconds)
    ...
    // Play aur pause functions
    const play = () => setIsPlaying(true);
    const pause = () => setIsPlaying(false);

    // Context value provide karna
    return (
